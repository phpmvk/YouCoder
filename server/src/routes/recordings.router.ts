...
const router = Router();
import { uploadRecordingController, getRecordingByIdController, recordingsQueryController, getAllUserRecordingsController, updateRecordingController, deleteRecordingController, incrementRecordingLikesController } from '../controllers/recordings.controller'
...
router.get('/search', defaultLimiter, recordingsQueryController)
