...
const recording = {title: 'Javascript Functions Explained Longer Again AGAIN Pt. 2',
      ...
      <div className=" bg-bg-gptdark border-solid p-2 mx-auto  pt-20 top-[20px] mb-1 rounded-lg overflow-y-scroll pb-[10px]">
        ...
        <div className="w-full bg-bg-gpt-dark h-[400px] bottom-[20px] mt-[10px] rounded-lg">
          ...
          <div className="bg-bg-gptdark flex flex-col md:flex-row h-full md:min-w-full text-center">
            {/* small title */}
          <div className="text-white text-3xl text-left pb-2 pt-4 px-6 mx-auto md:hidden ">{recording.title}</div>
          {/* <div className="text-white text-3xl whitespace-nowrap pb-2 pt-4 max-w-[30ch] text-ellipsis overflow-hidden mx-auto md:hidden">{recording.title}</div> */}
              ...
              <div className="h-[100px] w-[100px] flex-shrink-0 mt-1 md:ml-[50px] sm:ml-[25px] rounded-full border-2 border-bg-alt bg-cover bg-center bg-red-900" style={{ backgroundImage: `url(./../../public/avatar.webp)` }}></div>
...
<div className="bg-bg-gptdark px-4 pt-2 md:hidden w-full  ">
        ...
        <div className="bg-bg-gptdark text-gray-200 text-l text-left pt-6 px-6 w-full">{recording.description}</div>
        </div>
</div>
  ...
  <div className="flex flex-col w-full">
    <div className="flex justify-between items-start">
      <div className="flex flex-col">
        <div className="text-white lg:text-4xl md:text-3xl max-sm:hidden max-md:hidden  whitespace-nowrap p-4 max-w-[30ch] text-ellipsis overflow-hidden text-center">{recording.title}</div>
      </div>
     ...
     <div>
    <div className="max-md:hidden bg-bg-gptdark text-gray-200 text-l text-left p-4 w-full">{recording.description}</div>
