export default function Page500() {
  return (
    <div className='bg-bg-pri w-full  flex-grow overflow-y:hidden flex p-10'>
      {/* <div className='text-5xl bg-slate-500 text-white w-full flex-col py-20 px-20 font-title'> */}
      <div className='text-5xl bg-bg-gptdark text-white w-full flex-col py-5 px-10 font-title'>
