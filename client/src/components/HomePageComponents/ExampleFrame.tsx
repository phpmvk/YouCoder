...
const ExampleFrame: React.FC = () => {
  ...
  return (
    ...
    {/* <div className="w-[100vw] h-[12.5vw] bg-white">
      ...
      > */}
      <div 
    className="absolute w-screen h-[12.5vw] top-[420vw] sm:top-[430vw] 700:top-[410vw] md:top-[360vw] 900:top-[350vw] lg:top-[355vw] xl:top-[362vw] flex justify-center items-center"
>
    <motion.div
