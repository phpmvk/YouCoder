...
const LoginArt = () => {
  return (
    <div className='relative '>
      <div className='x bg-[radial-gradient(ellipse_at_bottom_right,_var(--tw-gradient-stops))] from-violet-900 via-zinc-400 to-bg-sec rounded-full h-[900px] w-[900px] my-8 ml-10 animate-spin-xslow'></div>
