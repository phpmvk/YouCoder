...
const LoginArt = () => {
  return (
    ...
    <div className=" y h-[350px] w-[350px]  opacity rounded-full absolute top-1/2 left-1/2 transform translate-x-1 -translate-y-1/2 translate-x-[-50%] translate-y-[-50%] text-black text-7xl font-bold font-title flex justify-center items-center">
      <div className="text-left">
        <div>Code.</div>
        <div>Record<span className="text-red-700 animate-[blinking_1s_infinite]">.</span></div>
        <div>Share.</div>
        <div>Engage.</div>
      </div>
    </div>
